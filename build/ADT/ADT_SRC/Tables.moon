chat1 = {
    ...
    [keys.a]: {
        ...
        [keys.a]: {
            ...
            [keys.a]: {
                text: "DONT FUCK WITH MY BUTTER"
            }
            [keys.b]: {
                text: "yeah im glad im a butter collector and not
    ...
    [keys.b]: {
        text: "That is because BUTTER IS AMAZING
        ...
        [keys.s]: {
            text: "YOU TASTE LIKE SHIT ILL FUCKING KILL YOU"
        }
    }
    ...
    [keys.f]: {
        text: "It doesnt get put back, the holy butter gods produce
